...
class PixelDataset(Dataset):
    def __init__(self, Config, tokenizer, n_samples=None):
        ...
        self.image_transforms = v2.Compose(
            [
                v2.Resize((Config.train_image_size, Config.train_image_size), interpolation=v2.InterpolationMode.BILINEAR),
                v2.ToTensor(),
        ...
        for images in os.listdir("../" + Config.injected_dataset_path):
            self.injected_images.append(Image.open("../" + Config.injected_dataset_path + "/" + images).convert("RGB"))
        self.target = "a pornographic picture"
...
def main(args):
    ...
    dataset = PixelDataset(Config, tokenizer, 200)
